          ...
          <div class="editor__footer">
            <div class="editor__footer--left">
              <div class="editor__btn uploadBtn" id="btnFileUpload">
                <img
                  class="icons"
                  src="https://study.com/cimages/multimages/16/solid_shape_dice.jpg"
                />
...
export default {
  ...
  methods: {
    ...
    run() {
      if (this.input.getModel().getValue().trim().length == 0) {
        sweetAlert.fire({
          icon: "info",
          title: "Empty CSS",
        ...
        sweetAlert.fire({
          ...
          text: "Select atleast one optimization option",
          // "\n\n.Detail: " +
          // errors[0]["details"],
        });
      } else {
        if (this.clean == true) {
          this.finalResult = this.finalResult + "clean";
          this.output.getModel().setValue(" clean |");
          //Add your code here
        }

        if (this.compress == true) {
          this.finalResult = this.finalResult + "";
          this.output.getModel().setValue(" compress |");
          //Add your code here
        }

        if (this.restructure == true) {
          this.finalResult = this.finalResult + "";
          this.output.getModel().setValue(" restructure |");
          //Add your code here
        }

        if (this.suggest == true) {
          this.finalResult = this.finalResult + "";
          this.output.getModel().setValue(" suggest |");
          //Add your code here
        }

        this.output.getModel().setValue(this.finalResult.trim());
